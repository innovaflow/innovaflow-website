...
export default function ContactHero() {
  ...
  return (
    <Section className="relative min-h-[50vh] flex items-center justify-center bg-gradient-to-b from-background via-background-surface to-background pt-32">
      <Container>
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          >
            Raccontaci il tuo business, ti diremo se possiamo aiutarti.
            Se non siamo la soluzione giusta, te lo diciamo chiaro.
          </p>
        </div>
      </Container>
